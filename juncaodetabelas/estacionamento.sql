...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02/09/2025 às 14:06
...
(1, '123.456.789-00', '1985-06-15 00:00:00', 'João Silva'),
(2, '987.654.321-00', '1990-11-22 00:00:00', 'Maria Oliveira'),
(3, '321.654.987-00', '1978-03-10 00:00:00', 'Carlos Souza'),
(4, '123.456.789-00', '1985-06-15 00:00:00', 'João Silva'),
(5, '987.654.321-00', '1990-11-22 00:00:00', 'Maria Oliveira'),
(6, '321.654.987-00', '1978-03-10 00:00:00', 'Carlos Souza');
...
(1, '2025-09-01 18:00:00', '2025-09-01 00:00:00', '0000-00-00 00:00:00', '2025-09-01 00:00:00', 1, 1),
...
(4, '2025-09-01 18:00:00', '2025-09-01 00:00:00', '0000-00-00 00:00:00', '2025-09-01 00:00:00', 1, 1),
(5, '2025-09-01 19:30:00', '2025-09-01 00:00:00', '0000-00-00 00:00:00', '2025-09-01 00:00:00', 2, 2),
(6, '2025-09-01 20:00:00', '2025-09-01 00:00:00', '0000-00-00 00:00:00', '2025-09-01 00:00:00', 3, 3);
...
INSERT INTO `veiculo` (`codveiculo`, `placa`, `cor`, `cpf`, `codmodelo`) VALUES
(1, 1234567, 'Vermelho', '123.456.789-00', 1),
(2, 2345678, 'Preto', '987.654.321-00', 2),
(3, 3456789, 'Branco', '321.654.987-00', 3),
(4, 1234567, 'Prata', '123.456.789-00', 1),
(5, 2345678, 'Preto', '987.654.321-00', 2),
(6, 3456789, 'Branco', '321.654.987-00', 3);
...
--
ALTER TABLE `andar`
  MODIFY `codlugar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `estaciona`
  MODIFY `codestaciona` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `veiculo`
  MODIFY `codveiculo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
